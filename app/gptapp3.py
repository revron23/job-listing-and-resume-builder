# -*- coding: utf-8 -*-
"""
Created on Fri Oct 13 01:17:06 2023
...
if show_resume:
    ...
    st.session_state.pop("linkedin", None)
    st.session_state.pop("social_media", None)
    st.session_state.pop("projects", None)
    st.session_state.pop("experience_qualifications", None)
    st.session_state.pop("hard_skills", None)
    st.session_state.pop("work_history", None)
